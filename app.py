...
st.set_page_config(page_title="AI Mood DJ", page_icon="🎵", layout="wide")
...
def main():
    ...
    try:
        ...
        st.error(f"An error occurred during authentication. Please check your secrets and Google Cloud setup. Error: {e}")
        st.stop()
